	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					'bg-background shadow-xs hover:bg-lapita hover:text-black dark:bg-input/30 dark:border-input dark:hover:bg-lapita border',
				secondary: 'bg-lapita text-neutral-800 shadow-xs hover:bg-lapita/80',
